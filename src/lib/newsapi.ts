...
const CATEGORY_QUERIES: { [key: string]: string } = {
  ...
  "Fast Fashion": `(viral OR trending OR "selling fast" OR "sold out" OR bestseller) AND (${FAST_FASHION_BRANDS})`,
  "Royal Classics": `("evening gown" OR "ball gown" OR couture OR "red carpet" OR "royal" OR "princess" OR "duchess" OR "Kate Middleton" OR "Meghan Markle" OR "timeless" OR "classic" OR ${LUXURY_FASHION_HOUSES}) AND (viral OR trending OR "sold out" OR "most-wanted")`,
  ...
  "All Fashion": `(viral OR "going viral" OR trending OR "sold out" OR bestseller OR "most-wanted") AND (fashion OR style OR trend OR ${FAST_FASHION_BRANDS} OR ${LUXURY_FASHION_HOUSES})`,
};
